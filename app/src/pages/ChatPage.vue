        ...
        <div class="flex items-center justify-center">
          <div class="space-y-2 w-1/2">
            <div
              ...
              :class="[
                message.from === 'teacher' ? 'bg-teal-100' : 'bg-blue-100',
              ]"
            >
              {{ message.text }}
            </div>
      ...
      <div class="max-w-2xl mx-auto">
        ...
        <div class="mt-4">
          ...
          <div class="flex justify-center">
            <button
              @click="submitComment"
              class="mt-2 px-12 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600"
            >
              送信
            </button>
          </div>
